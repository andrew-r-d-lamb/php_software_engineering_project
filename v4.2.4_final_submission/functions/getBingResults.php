...
function getBingResults(&$results) 
{
    ...
    //SET NUMBER OF RESULTS TO GET:
    if ($_POST['numResults'] === '10' || $_POST['numResults'] === '50') {
        //Sets number of results desired (1-50).
        $numResultsBing = $_POST['numResults'];  
    }
    if ($_POST['numResults'] === '100') {
        //Sets number of results desired (1-50).
        $numResultsBing = 50;  
    }
    ...
    //***************************************************************************
    if ($_POST['numResults'] == '100') {
        //Bing max results returned in one go is 50, 
        //so need to request second set of 50 results
        $requestUri 
