 ...
 */
/**
 * Function takes in an array by reference, and populates it with results from Blekko
 * 
    ...
    if (isset($jsonObj->RESULT)) {
        foreach ($jsonObj->RESULT as $item) {
            ...
            if (isset($item->snippet)) {
                ...
                $snippet = $item->url_title; //because no snippet available
            }

            //add variables to the array.  key by URL
            //$results[$url] = array($urlTitle, $snippet);
            $results[$i++] = (array(
