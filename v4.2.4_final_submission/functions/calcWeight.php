 ...
 * calculates the weights to be applied to each array / result-set by
 * using the wsum technique which weights results based on their combined score
