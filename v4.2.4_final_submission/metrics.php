...
//Create counter variable which will be used for showing/hiding metrics
session_start();
...
if (isset($_POST['theMetrics'])) {
    if ($_POST['metrics'] === 'metricsCalc') {
        if ($_SESSION['counter'] % 2 === 0 ) {
            ...
            unset($_SESSION['counter']); //reset the counter
        } else {
            //hide metrics
        }
...
//reset session variable to 1 in case user has navigated away from page
