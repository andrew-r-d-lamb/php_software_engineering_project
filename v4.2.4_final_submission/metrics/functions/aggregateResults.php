    ...
    foreach ($set1 as $set1Key => &$set1Value) {
        $aggregatedSet[$k] = (
            array($set1Value[0], $set1Value[1], 
                ...
                $set1Value[5])); //add each set1Result to aggregated Array
        ...
        if ($set2Value[4] === 'n') {
            $aggregatedSet[$k] = (
                array($set2Value[0], $set2Value[1], 
                    ...
                    $set2Value[5])); //add each set2Result to aggregated Array
            foreach ($set3 as $set3Key => &$set3Value) {
        ...
        if ($set3Value[4] === 'n') {
            $aggregatedSet[$k] = (
                array($set3Value[0], $set3Value[1], 
                    ...
                    $set3Value[5])); //add each set3Result to aggregated Array
            $k++;
        }
    }
    //******************************************************************************
